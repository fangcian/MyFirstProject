package com.fangc0000ian.myfirstproject
...
import com.fangcian.myfirstproject.MainActivity
import com.fangcian.myfirstproject.R
import com.fangcian.myfirstproject.model.Rank
...
class HomeFragment : Fragment() {
    ...
    private var mRankData: Rank? = null
        ...
        OkHttpClient().newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call?, response: Response?) {
                ...
                mMainActivity.runOnUiThread {
                    ...
                    if (StatusCode == 200) {
                        mRankData= Gson().fromJson(ResMessage, Rank::class.java)
    ...
    inner class RankAdapter : RecyclerView.Adapter<RankAdapter.ViewHolder>(){
        ...
        override fun onBindViewHolder(holder: ViewHolder?, position: Int) {
            ...
            holder!!.tv_block_count.text = "票數差：${mRankData?.images?.feature_1!![position].real_count}"
            holder!!.tv_block_fileName.text = mRankData?.images?.feature_1!![position].image_name
