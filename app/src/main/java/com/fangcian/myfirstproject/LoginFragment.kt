package com.fangcian.myfirstproject
...
import com.fangc0000ian.myfirstproject.HomeFragment
...
class LoginFragment : Fragment() {
    ...
    private fun initViews(view: View) {
        view.bt_login.setOnClickListener {
            if (et_account.text.toString() == "fangcian" && et_password.text.toString() == "123") {
